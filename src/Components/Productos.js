export const products = [
    ...
    }, 
    {
      ...
      category: 'Ps3',
      precio: 9.99,
      descripcion: "ICO Classics HD PSN es la adaptación en alta definición y para PlayStation 3 de ICO, el videojuego de SCE Japan Studio lanzado en PlayStation 2 y considerado una obra de culto. Se trata de una aventura en la que teníamos que escapar de una enorme fortaleza acompañados de misteriosa joven, y aunque no fue un éxito de ventas, con el paso de los años se convirtió en un referente especial dentro del mundo de los videojuegos.",
      img: "https://i.3djuegos.com/juegos/6577/ico_and_shadow_of_the_colossus_the_collection/fotos/ficha/ico_and_shadow_of_the_colossus_the_collection-1723893.jpg"
    },
    {
      id: 5,
      ...
      img: "https://i.3djuegos.com/juegos/13424/red_dead_3__nombre_temporal_/fotos/ficha/red_dead_3__nombre_temporal_-5009894.jpg"
    },
    {
      id: 6,
    ...
    },
    {
      ...
      category: 'Ps3',
      precio: 3.99,
      descripcion: "Cuarta parte de la saga Metal Gear Solid, que continúa las aventuras de Solid Snake llevándonos a un futuro cercano, en 2014, en el que Snake ha envejecido prematuramente y es un anciano. Tendremos que infiltrarnos a petición de la ONU en una guerra dominada por las corporaciones privadas, controladas a su vez por los antiguos enemigos de Snake.",
      img: "https://i.3djuegos.com/juegos/1421/metal_gear_solid_4_guns_of_the_patriots/fotos/ficha/metal_gear_solid_4_guns_of_the_patriots-1686810.jpg"
    },
    {
      id: 8,
      name: "Far Cry 4",
      category: 'PC',
      precio: 4.99,
      descripcion: "Far Cry 4 para PS4 es una nueva entrega de esta saga de acción en primera persona, que nos lleva esta vez al Himalaya, a la región de Kyrat, para enfrentarnos a una especie de tirano que se ha proclamado rey de la zona y se comporta de manera brutal con los habitantes. Encarnaremos a Ajay Ghale, que tendrá que viajar a la región de Kyrat para cumplir el último deseo de su madre, viéndose envuelto en la guerra civil que se está librando.",
      img: "https://i.3djuegos.com/juegos/10320/far_cry_4/fotos/ficha/far_cry_4-2550475.jpg"
    },
